        ...
        <div className="chatbot-wrapper">
          ...
          <form className="chatbot-form" onSubmit={sendMessage}>
            <div className="chatbot-input-container">
              ...
              >
                {isInCall ? (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" className="mic-stop-icon">
                    <rect x="5" y="5" width="14" height="14" rx="2"></rect>
                  </svg>
                ) : (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="mic-icon" width="18" height="18">
